...
public class VideoViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            truitonTask.execute("https://www.googleapis.com/youtube/v3/videos?id=TNpQPawBTtM&key=52308510166-qbra2ediu29l2s738nno24ekc8tcovra.apps.googleusercontent.com&part=snippet");
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        //getMenuInflater().inflate(R.menu.videoView1, menu);
        return true;
    }
