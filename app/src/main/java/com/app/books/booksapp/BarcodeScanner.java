...
public class BarcodeScanner extends AppCompatActivity {
    ...
    private void initControls() {
        ...
        iv = (ImageView) findViewById(R.id.my_own_image_view);
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (result != 0) {
                ...
                for (Symbol sym : syms) {
                    ...
                    Result_Intent.putExtra("SCAN_RESULT", scanResult);
                    setResult(HistoryFragment.ACTIVITY_RESULT_QR_DRDROID, Result_Intent);
                    finish();
